...
from app.forms import RegistrationForm, LoginForm, UpdateAccountForm, RequestResetForm, ResetPasswordForm, AdminAddProductForm
...
def snackPage():
    ...
    return render_template("index.html", specials=specials, sweets=sweets, khakharas=khakharas, drysnacks=drysnacks)
